...
-- Obtenir l'ID du rôle agriculteur
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Rakotomavo', 'Hery', 'hery.rakotomavo@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/riz.jpeg', NOW(), NOW()),
    ('Razafy', 'Hanta', 'hanta.razafy@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/manioc.jpg', NOW(), NOW());

    -- Région Haute Matsiatra (3 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Randriamampionona', 'Jean', 'jean.randriamampionona@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/arachide.jpg', NOW(), NOW()),
    ('Rasolofo', 'Naina', 'naina.rasolofo@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/haricot_blanc.jpg', NOW(), NOW()),
    ('Rakotonirina', 'Fara', 'fara.rakotonirina@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/pois_bambara.jpg', NOW(), NOW());

    -- Région Vatovavy-Fitovinany (2 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Rabe', 'Lanto', 'lanto.rabe@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/riz.jpeg', NOW(), NOW()),
    ('Raharimina', 'Vola', 'vola.raharimina@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/manioc.jpg', NOW(), NOW());

    -- Région Atsimo-Atsinanana (2 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Rakotozafy', 'Mamy', 'mamy.rakotozafy@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/arachide.jpg', NOW(), NOW()),
    ('Ratsimba', 'Haja', 'haja.ratsimba@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/haricot_blanc.jpg', NOW(), NOW());

    -- Région Ihorombe (1 agriculteur)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Razafindrakoto', 'Solo', 'solo.razafindrakoto@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/pois_bambara.jpg', NOW(), NOW());

    -- Région Atsimo-Andrefana (3 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Ramaroson', 'Koto', 'koto.ramaroson@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/riz.jpeg', NOW(), NOW()),
    ('Rakotoarisoa', 'Miora', 'miora.rakotoarisoa@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/manioc.jpg', NOW(), NOW()),
    ('Randriamanantena', 'Zo', 'zo.randriamanantena@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/arachide.jpg', NOW(), NOW());

    -- Région Menabe (2 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Rasoamampionona', 'Tahina', 'tahina.rasoamampionona@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/haricot_blanc.jpg', NOW(), NOW()),
    ('Rafanomezantsoa', 'Bako', 'bako.rafanomezantsoa@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/pois_bambara.jpg', NOW(), NOW());

    -- Région Androy (2 agriculteurs)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Razanakolona', 'Fidy', 'fidy.razanakolona@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/riz.jpeg', NOW(), NOW()),
    ('Rakotondrabe', 'Tsiry', 'tsiry.rakotondrabe@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/manioc.jpg', NOW(), NOW());

    -- Région Anosy (1 agriculteur)
    INSERT INTO utilisateur (nom, prenoms, email, mot_de_passe, id_role, photo_profil, created_at, modified_at)
    VALUES 
    ('Ramanantsoa', 'Nivo', 'nivo.ramanantsoa@example.mg', '$2a$10$8K1p4VXK8vF5h4PqJ3TG5.5mZb4w0K1K3FyAl.o0L6LN.9VcXQtgC', role_agriculteur_id, '/cultures/arachide.jpg', NOW(), NOW());
...
DECLARE
    ...
    -- Variables pour les données de référence
    cultures_data RECORD;
    regions_data RECORD;
    districts_data RECORD;
    communes_data RECORD;
    ...
    -- Arrays pour les statuts et cultures
    statuts_array TEXT[] := ARRAY['en_attente_validation', 'en_financement', 'validé', 'en_cours'];
...
BEGIN
    ...
    FOR i IN 1..50 LOOP
        ...
        INSERT INTO projet (
            ...
            photos, created_at, modified_at, created_by,
        ...
        INSERT INTO projet_culture (
            ...
            rendement_previsionnel, created_at, modified_at, created_by
        ) VALUES (
            ...
            NOW(), NOW(), current_agriculteur::text
        );
        
        -- Génération des investissements selon le statut
        IF current_statut IN ('en_financement', 'validé', 'en_cours') THEN
            DECLARE
                cout_total NUMERIC;
            ...
            BEGIN
                ...
                FOR j IN 1..nb_investisseurs LOOP
                    IF array_length(investisseurs, 1) > 0 THEN
                        ...
                        INSERT INTO investissement (
                            ...
                            NOW(), NOW(), current_investisseur::text
                        );
                    END IF;
                END LOOP;
            END;
...
BEGIN
    ...
    FOR projet_record IN SELECT id_projet FROM projet LOOP
        ...
        FOR i IN 1..nb_likes LOOP
            ...
            INSERT INTO aimer_projet (id_projet, id_utilisateur, created_at, modified_at, created_by)
            VALUES (projet_record.id_projet, utilisateur_id, NOW(), NOW(), utilisateur_id::text)
        ...
        FOR i IN 1..nb_commentaires LOOP
            utilisateur_id := utilisateurs_actifs[1 + (random() * array_length(utilisateurs_actifs, 1))::integer % array_length(utilisateurs_actifs, 1)];
            INSERT INTO commentaire (id_projet, id_utilisateur, texte, date_creation, date_modification, created_by, modified_at)
            VALUES (
...
SELECT setval('terrain_id_terrain_seq', (SELECT MAX(id_terrain) FROM terrain));
SELECT setval('projet_id_projet_seq', (SELECT MAX(id_projet) FROM projet));
SELECT setval('projet_culture_id_projet_culture_seq', (SELECT MAX(id_projet_culture) FROM projet_culture));
SELECT setval('investissement_id_investissement_seq', (SELECT MAX(id_investissement) FROM investissement));
SELECT setval('jalon_projet_id_jalon_projet_seq', (SELECT MAX(id_jalon_projet) FROM jalon_projet));
SELECT setval('cout_jalon_projet_id_cout_jalon_projet_seq', (SELECT MAX(id_cout_jalon_projet) FROM cout_jalon_projet));
SELECT setval('aimer_projet_id_aimer_projet_seq', (SELECT MAX(id_aimer_projet) FROM aimer_projet));
...
BEGIN
    ...
    RAISE NOTICE 'Mot de passe uniforme: louna$619';
