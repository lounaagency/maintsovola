-- ============================================================================
-- MIGRATION COMPLÈTE DE STABILISATION DU SYSTÈME JALON/BUDGET
-- ============================================================================
...
-- 2. CONTRAINTES D'UNICITÉ ET INDEX POUR COHÉRENCE FUTURE
-- ============================================================================
...
-- Contrainte d'unicité sur cout_jalon_reference (éviter doublons coûts)
DO $$ 
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
...
-- 3. HARMONISATION DES TRIGGERS ET FONCTIONS
-- ============================================================================
...
BEGIN
    ...
    IF NEW.statut = 'en_cours' AND (OLD.statut IS NULL OR OLD.statut != 'en_cours') THEN
        ...
        ON CONFLICT DO NOTHING; -- Éviter les doublons si coûts déjà créés
    END IF;
...
-- 4. RLS POLICIES POUR jalon_projet
-- ============================================================================
...
-- 5. COMPLÉTER LES COÛTS MANQUANTS POUR HARICOT BLANC
-- ============================================================================
