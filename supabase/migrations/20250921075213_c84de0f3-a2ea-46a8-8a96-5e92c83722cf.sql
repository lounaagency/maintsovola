-- ============================================================================
-- MIGRATION COMPLÈTE: VIDANGE ET NOUVELLES DONNÉES DE DÉMONSTRATION
-- ============================================================================
...
-- 3.1 Insertion de terrains validés (12 terrains répartis géographiquement)
INSERT INTO terrain (
    id_tantsaha, surface_proposee_ha, surface_validee_ha, 
...
('3c4d5e6f-7a8b-9c0d-1e2f-3456789abcde', 4, 'Pois Bambara Durable', 'Culture traditionnelle améliorée de pois bambara', 2.8, 'en financement', 2, 2, 2,
 ...
 '9c3f2a54-5d67-589a-a123-456789abcdef', '1e5d8c91-8f23-4567-890a-bcdef1234567', '3c4d5e6f-7a8b-9c0d-1e2f-3456789abcde'),
...
-- 3.4 Génération automatique des jalons et coûts pour les projets 'en cours'
-- (La fonction trigger se chargera de créer les jalons automatiquement)

-- 3.5 Insertion d'investissements réalistes
...
-- 3.6 Insertion de l'historique des paiements d'investissement
...
-- 3.7 Déclencher la génération des jalons pour les projets 'en cours'
UPDATE projet SET statut = 'en cours' WHERE statut = 'en cours';

-- 3.8 Mise à jour manuelle du statut de quelques jalons pour simuler l'avancement
UPDATE jalon_projet 
...
-- 3.9 Insertion de quelques paiements aux techniciens
